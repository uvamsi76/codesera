...
export const courseSchema = z.object({
    ...
    price: wholeNumberSchema.refine((val: number)=>val>=0 && val<=100000,{message:"price shld be below 100000"}), //{type:Number},//5000,
    ...
    rating:wholeNumberSchema.refine((val: number)=> val>=0&&val<=5 ,{message:"rating should be between 0-5"}),//{type:Number},//4.5,
